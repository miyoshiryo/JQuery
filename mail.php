...
$site_top = "https://ryomiyoshi.com/hp2/index.html";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "r.miyoshi7121@gmail.com";
...
$Referer_check_domain = "ryomiyoshi.com";
...
$thanksPage = "https://ryomiyoshi.com/hp2/index.html";
...
$require = array('subject', 'Name', 'Email', 'message');
